...
# Figure S3a - density plot showing expected distribution for various k-mer lengths, in protein genes
...
# Figure S3b - density plot showing expected distribution for various k-mer lengths, in RNA and non-coding loci
...
ggsave("supplementary_figures/FigureS3.jpeg", width = 180, height = 90, dpi = 600, units = c("mm"))
