...
write.table(file[, c("locus", "start", "end", "consequence", "observed", "expected", "obs.exp", "lower_CI", "upper_CI")], 
            file = 'supplementary_datasets/supplementary_dataset_1.tsv', col.names = c("Symbol", "Start_position", "End_position", "Consequence", "Observed", "Expected", "obs:exp", "Lower_CI", "Upper_CI"), row.names = FALSE, sep = '\t')
...
write.table(file[, c("locus", "start", "end", "protein_pos_start", "protein_pos_end", "obs_max_het", "exp_max_het", "ratio_oe", "lower_CI", "upper_CI")], 
            file = 'supplementary_datasets/supplementary_dataset_2.tsv', col.names = c("Symbol", "Start_position", "End_position", "Protein_residue_start", "Protein_residue_end", "Observed", "Expected", "obs:exp", "Lower_CI", "Upper_CI"), row.names = FALSE, sep = '\t')
...
write.table(mcri[order(mcri$POS), c("POS", "REF", "ALT", "Classification")], 
            file = 'supplementary_datasets/supplementary_dataset_3.tsv', col.names = c("Position", "Reference", "Alternate", "Classification_group"), row.names = FALSE, sep = '\t')
...
write.table(file[c(2:23,75,24:48,76,49:52,71:72,53:59,73:74,60:70), c("tRNA_position", "observed", "expected", "obs.exp", "lower_CI", "upper_CI")], 
            file = 'supplementary_datasets/supplementary_dataset_4.tsv', col.names = c("tRNA_position", "Observed", "Expected", "obs:exp", "Lower_CI", "Upper_CI"), row.names = FALSE, sep = '\t')
...
write.table(file[, c("locus", "description", "start", "end", "observed", "expected", "obs.exp", "lower_CI", "upper_CI")], 
            file = 'supplementary_datasets/supplementary_dataset_5.tsv', col.names = c("Locus", "Description", "Start_position", "End_position", "Observed", "Expected", "obs:exp", "Lower_CI", "Upper_CI"), row.names = FALSE, sep = '\t')
...
write.table(unique(file[, c("POS", "MLC_pos_score")]), 
            file = 'supplementary_datasets/supplementary_dataset_6.tsv', col.names = c("Position", "MLC_pos_score"), row.names = FALSE, sep = '\t')
...
write.table(file[, c("POS", "REF", "ALT", "consequence", "MLC_var_score")], 
            file = 'supplementary_datasets/supplementary_dataset_7.tsv', col.names = c("Position", "Reference", "Alternate", "Consequence", "MLC_score"), row.names = FALSE, sep = '\t')


# Supplementary Dataset 8 - curated confirmed MITOMAP variants by plasmy
...
write.table(file[grepl("missense|transcript", file$consequence) & !grepl("gain|lost|terminal", file$consequence), c("var", "symbol", "mitomap_plasmy", "curated_status", "curated_homoplasmy_report")], 
            file = 'supplementary_datasets/supplementary_dataset_8.tsv', col.names = c("Variant", "Symbol", "MITOMAP_plasmy", "Curated_status", "Curated_homoplasmy_report"), row.names = FALSE, sep = '\t')
