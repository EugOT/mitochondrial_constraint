...
def draw_mito():
	with open('figure_scripts/figures/Figure4_mtDNA.svg', 'w') as svg_output:
...
if __name__ == "__main__":
	draw_mito()
	figure = svg2rlg('figure_scripts/figures/Figure4_mtDNA.svg')
	renderPM.drawToFile(figure, 'figure_scripts/figures/Figure4_mtDNA.png', fmt='PNG')
