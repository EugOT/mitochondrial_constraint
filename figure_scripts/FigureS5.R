...
# Figure S5a - schematic overview of method used for MLC

fig <- readPNG("supplementary_figures/FigureS5a.png")  
plotA <- ggplot() + 
  background_image(fig) +
  theme(panel.background = element_rect(fill = 'white', color = 'white'))


# Figure S5b - plot MLC position scores vs mean OEUF values
...
ggsave("supplementary_figures/FigureS5.jpeg", width = 180, height = 50, dpi = 600, units = c("mm"))