...
# Figure ED7a - plot MLC position scores in the control region
...
svg <- readPNG("extended_data_figures/FigureED7a-left.png") 
plot_top_left <- ggplot() + 
  background_image(svg) +
  theme(plot.margin = unit(c(0.3, 0.25, 0.2, 0.9), "cm"))

svg <- readPNG("extended_data_figures/FigureED7a-right.png") 
...
# Figure ED7b-d - plot allele frequency data across control region
...
ggsave("extended_data_figures/FigureED7.jpeg", width = 180, height = 165, dpi = 600, units = c("mm"))
